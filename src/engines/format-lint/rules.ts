...
import { isJsTsFile, makeDiagnostic } from './helpers.js'

// ── Rule 1: inconsistent-indent ────────────────────
// Detects files that mix tabs and spaces for indentation

export function detectInconsistentIndent(
  content: string,
...
export function detectInconsistentQuotes(
  content: string,
  lines: { num: number; text: string }[],
  filePath: string,
): Diagnostic[] {
...
export function detectMaxLineLength(
  content: string,
  lines: { num: number; text: string }[],
  filePath: string,
  maxLength: number,
...
export function detectInconsistentSemicolons(
  content: string,
  lines: { num: number; text: string }[],
  filePath: string,
): Diagnostic[] {
...
export function detectBlankLineCluster(
  content: string,
  lines: { num: number; text: string }[],
  filePath: string,
): Diagnostic[] {
...
export function detectTrailingCommaInconsistency(
  content: string,
  lines: { num: number; text: string }[],
  filePath: string,
): Diagnostic[] {
