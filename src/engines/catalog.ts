...
const FIXABLE_RULES = new Set([
  ...
  'dup-detect/identical-block',
  'dup-detect/repeated-constant',
  'dead-flow/unused-export',
  'perf-hints/sync-in-async',
  'perf-hints/string-concat-in-loop',
  'arch-constraints/high-coupling',
  'arch-constraints/god-file',
  'security-deep/prototype-pollution',
  'ast-slop/hardcoded-config',
  ...
  'python-deep/bare-except',
  'python-deep/mutable-default',
  'python-deep/f-string-in-log',
  'python-deep/pass-stub',
  'python-deep/print-statement',
